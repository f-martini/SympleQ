...
Measurement::PauliSum GetHamiltonian(std::string const& hamiltonian) { return {}; }

std::vector<std::complex<double>> GetPsi(std::vector<std::complex<double>> psi) { return {}; }

Measurement::AquireConfig GetAquireConfig(std::map<std::string, nb::object> const& config) { return {}; }
